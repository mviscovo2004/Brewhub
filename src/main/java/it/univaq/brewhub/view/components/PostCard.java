    ...
    private void showShareDialog() {
        ...
        btnSend.setOnAction(e -> {
            ...
            if (receiver != null && !receiver.isBlank()) {
                try {
                    it.univaq.brewhub.model.Messaggio m = new it.univaq.brewhub.model.Messaggio();
    ...
    private void showAddReviewDialog() {
        ...
        btnConfirm.setOnAction(e -> {
            ...
            try {
                ...
                DialogUtils.showError("Errore", "Impossibile salvare recensione: " + ex.getMessage(), dialog);
            }
        });
