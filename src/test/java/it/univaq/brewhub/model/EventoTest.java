 ...
 *
 * Verifica la creazione di eventi, la gestione delle partecipazioni
...
public class EventoTest extends BaseTest {
     ...
     *
     * Controlla che un evento creato da un Torrefattore
     * venga salvato correttamente con un ID valido.
     *
     * 
     ...
     *
     * Controlla che un utente possa partecipare a un evento
     * e che il conteggio dei partecipanti sia corretto.
     *
     * 
     * @throws SQLException se si verifica un errore durante l'accesso al database
     */
     ...
     *
     * Controlla che un utente possa rimuovere la propria partecipazione
     * e che non risulti più tra i partecipanti.
     *
     * 
     * @throws SQLException se si verifica un errore durante l'accesso al database
     */
