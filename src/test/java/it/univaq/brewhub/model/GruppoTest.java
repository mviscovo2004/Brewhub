 ...
 *
 * Verifica i costruttori, i metodi getter/setter e le operazioni
 * CRUD sul database per i gruppi di chat.
 *
 */
public class GruppoTest extends BaseTest {
     ...
     *
     * Testa creazione di gruppi, aggiunta e rimozione di membri,
     * e recupero dei gruppi di un utente.
     *
     * 
